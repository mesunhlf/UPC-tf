...
class Network(object):
  ...
  def _region_proposal(self, net_conv, is_training, initializer):
    ...
    self._predictions["top_rpn_scores"] = rpn_scores
  ...
  def _return_Scores(self):
    return self._predictions["cls_score"],\
           self._predictions['cls_prob'],\
           self._predictions['bbox_pred'],\
           self._predictions['rois']

  def return_RPN_result(self,sess, images, image_infos):
    feed_dict = {self._image: images,
                 self._im_info: image_infos}
    rpn_cls_score_num,rpn_cls_prob_num,rpn_cls_pred_num,rpn_bbox_pred_num,rois_num = \
    sess.run([self._predictions["rpn_cls_score"],
                  self._predictions["rpn_cls_prob"],
                  self._predictions["rpn_cls_pred"],
                  self._predictions["rpn_bbox_pred"],
                  self._predictions["rois"]],
                 feed_dict=feed_dict)
    return rpn_cls_score_num,rpn_cls_prob_num,rpn_cls_pred_num,rpn_bbox_pred_num,rois_num
  ...
  def create_evaluation_architecture(self, mode, num_classes, tag=None,
